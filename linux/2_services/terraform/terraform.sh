...
tf_vers=13; curl -O https://releases.hashicorp.com/terraform/0.$tf_vers.0/terraform_0.$tf_vers.0_linux_amd64.zip && unzip terraform_0.$tf_vers.0_linux_amd64.zip && sudo cp terraform /usr/bin/ && sudo rm terraform*
